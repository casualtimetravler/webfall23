...
<head>
 ...
 <!--make user by specific password by using php and myql for loging by the admins not everyone-->
<body>
...
$validEmail = 'kewar.sherzadf20@komar.edu.iq';
$validPassword = 'kewar22';
