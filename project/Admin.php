...
<head>
 ...
 <!--we need make 2 more pages for the frontend because we have two button user books and book manager both of them need a diffrent page-->
<body>
  ...
  <div class="container mt-4">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <a href="bookmanager.php" class="btn btn-primary">Go to Book Management</a>
      </div>
    </div>
    ...
    <div class="card mt-4">
      <div class="card-body">
        <h5 class="card-title">Book Suggestions</h5>
        <p class="card-text">Manage Books suggestion.</p>
        <a href="booksuggestions.php" class="btn btn-primary">Go to Suggestion Management</a>
      </div>
    </div>
